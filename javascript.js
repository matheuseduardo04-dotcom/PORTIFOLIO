  ...
  var translations = {
    pt: {
      ...
      'certs.title': 'Em busca da próxima conquista',
      'certs.copy': 'A certificação mais importante do meu plano de estudos, em andamento agora mesmo. Quando conquistada, será exibida aqui com todo o orgulho.',
      'certs.premium.status': 'Em conquista',
      'certs.premium.title': 'Python Certification',
      'certs.premium.desc': 'Certificação Python pela <strong>freeCodeCamp</strong> — a mais importante do meu plano de estudos. Ainda em progresso, mas o resultado vai valer cada hora investida.',
      'certs.premium.progress': 'Carregando conquista...',
    ...
    en: {
      ...
      'certs.title': 'Chasing the next achievement',
      'certs.copy': 'The most important certification in my study plan, in progress right now. When earned, it will be displayed here with pride.',
      'certs.premium.status': 'In progress',
      'certs.premium.title': 'Python Certification',
      'certs.premium.desc': 'Python Certification by <strong>freeCodeCamp</strong> — the most important one in my study plan. Still in progress, but the outcome will be worth every hour invested.',
      'certs.premium.progress': 'Loading achievement...',
